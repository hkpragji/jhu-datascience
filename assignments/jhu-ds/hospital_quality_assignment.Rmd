...
best <- function(chosen_state, chosen_outcome) {
  ...
  unique_outcomes <- c("heart attack" = "monthly_ha_mort_rate", 
                       "heart failure" = "monthly_hf_mort_rate", 
                       "pneumonia" = "monthly_pne_mort_rate")
  ...
  filtered_outcome_data <- outcome_data %>%
    dplyr::rename(
      ...
      "state" = State,
      "monthly_ha_mort_rate" = Hospital.30.Day.Death..Mortality..Rates.from.Heart.Attack,
      "monthly_hf_mort_rate" = Hospital.30.Day.Death..Mortality..Rates.from.Heart.Failure,
      "monthly_pne_mort_rate" = Hospital.30.Day.Death..Mortality..Rates.from.Pneumonia
    ) %>%
    dplyr::select(hospital, state, monthly_ha_mort_rate, monthly_hf_mort_rate, monthly_pne_mort_rate) %>%
    ...
    dplyr::select(hospital, outcome_rate = dplyr::all_of(unique_outcomes[[chosen_outcome]])) %>%
